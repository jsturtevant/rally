...
c connect IDE · l logs · n new dispatch · p upstream · x delete · r refresh · q quit
```
...
| `p` | Mark selected dispatch as "upstream" |
...
| `upstream` | Marked as waiting on upstream (manual status via dashboard `p` key) |
