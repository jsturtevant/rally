...
| **E8** | **Write dispatch e2e tests** — markdown files in `test/e2e/cli/dispatch/` covering: `dispatch-help.md` (help text for dispatch + subcommands), `dispatch-issue.md` (dispatch to fixture repo issue #1, verify worktree/branch/context creation, dashboard JSON shows dispatch, clean removes it), `dispatch-pr.md` (dispatch PR review to fixture repo PR #3, verify worktree/branch/REVIEW.md creation, clean removes it), `dispatch-sessions.md` (sessions output after dispatch). Uses `clone: jsturtevant/rally-test-fixtures` for real GitHub API integration. | E4, E2 | L |
