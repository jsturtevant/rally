 ...
 * Returns the child process (or null if Copilot CLI is unavailable).
 *
...
export function launchCopilot(worktreePath, prompt, opts = {}) {
  ...
  try {
    ...
    // Session ID capture would come from Copilot CLI output in production;
    // for now return the PID as an identifier.
