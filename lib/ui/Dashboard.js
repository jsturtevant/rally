...
function Dashboard({ project, onSelect, onAttachSession, onDispatchItem, onDispatch, getTrustWarnings: getTrustWarningsProp, onAddProject, refreshInterval = 5e3, _spawn = defaultSpawn, _dispatchRemove = defaultDispatchRemove, _parseSessionIdFromLog = defaultParseSessionId, _updateDispatchStatus = defaultUpdateDispatchStatus, _listOnboardedRepos, _fetchIssues, _fetchPrs }) {
  ...
  return /* @__PURE__ */ React.createElement(Box, { flexDirection: "column", borderStyle: "round", borderColor: "gray", paddingX: 1, height: stdout.rows }, /* @__PURE__ */ React.createElement(Box, { marginBottom: 1 }, /* @__PURE__ */ React.createElement(Text, { bold: true }, "\u{1F680} Rally Dashboard")), /* @__PURE__ */ React.createElement(DispatchTable, { dispatches: data.dispatches, selectedIndex }), /* @__PURE__ */ React.createElement(SummaryLine, { summary: data.summary }), /* @__PURE__ */ React.createElement(Box, { flexGrow: 1 }, /* @__PURE__ */ React.createElement(Text, null, " ")), /* @__PURE__ */ React.createElement(Box, { flexDirection: "column", alignItems: "center" }, /* @__PURE__ */ React.createElement(Text, { dimColor: true }, "\u2191/\u2193 navigate \xB7 Enter actions \xB7 d details \xB7 l logs \xB7 v open \xB7 o browser \xB7 c connect IDE"), /* @__PURE__ */ React.createElement(Text, { dimColor: true }, "n new dispatch \xB7 a attach \xB7 p pushed \xB7 x delete \xB7 r refresh \xB7 q quit")));
}
export {
  computeSummary,
