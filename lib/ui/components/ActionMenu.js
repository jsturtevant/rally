...
function ActionMenu({ dispatch, selectedAction, onSelect, onBack }) {
  ...
  return /* @__PURE__ */ React.createElement(Box, { flexDirection: "column", borderStyle: "round", borderColor: "gray", paddingX: 1, paddingY: 0 }, /* @__PURE__ */ React.createElement(Box, { marginBottom: 1 }, /* @__PURE__ */ React.createElement(Text, { bold: true }, "Actions for "), /* @__PURE__ */ React.createElement(Text, { bold: true, color: "cyan" }, typeLabel, " ", refLabel), /* @__PURE__ */ React.createElement(Text, { bold: true }, " (", dispatch.repo, ")")), actions.map((action, i) => /* @__PURE__ */ React.createElement(Box, { key: action.id }, /* @__PURE__ */ React.createElement(Text, { color: "cyan" }, i === selectedAction ? "\u276F " : "  "), /* @__PURE__ */ React.createElement(Text, { bold: i === selectedAction }, action.label))), /* @__PURE__ */ React.createElement(Box, { marginTop: 1 }, /* @__PURE__ */ React.createElement(Text, { dimColor: true }, "\u2191/\u2193 navigate \xB7 Enter select \xB7 Esc/q back")));
}
export {
  ACTIONS,
