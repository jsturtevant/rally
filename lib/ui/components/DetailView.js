...
function DetailView({ dispatch, onBack, terminalRows }) {
  ...
  return /* @__PURE__ */ React.createElement(Box, { flexDirection: "column", borderStyle: "round", borderColor: "gray", paddingX: 1 }, /* @__PURE__ */ React.createElement(Box, { marginBottom: 1 }, /* @__PURE__ */ React.createElement(Text, { bold: true }, "\u{1F4CB} Details for "), /* @__PURE__ */ React.createElement(Text, { bold: true, color: "cyan" }, issueRef), /* @__PURE__ */ React.createElement(Text, { bold: true }, " (", dispatch.repo, ")")), /* @__PURE__ */ React.createElement(Box, { flexDirection: "column" }, fields.map((f) => /* @__PURE__ */ React.createElement(Box, { key: f.label }, /* @__PURE__ */ React.createElement(Box, { width: 14 }, /* @__PURE__ */ React.createElement(Text, { bold: true }, f.label)), /* @__PURE__ */ React.createElement(Text, null, f.value))), Array.from({ length: padCount }, (_, i) => /* @__PURE__ */ React.createElement(Text, { key: `pad-${i}` }, " "))), /* @__PURE__ */ React.createElement(Box, { marginTop: 1 }, /* @__PURE__ */ React.createElement(Text, { dimColor: true }, "Esc/q back")));
}
export {
