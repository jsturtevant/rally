...
function ProjectItemPicker({ project, onSelectItem, onNewBranch, onBack, terminalRows, _fetchIssues, _fetchPrs }) {
  ...
  if (data && !hasIssuePrs) {
    return /* @__PURE__ */ React.createElement(Box, { flexDirection: "column", justifyContent: "space-between", borderStyle: "round", borderColor: "gray", paddingX: 1, height: terminalRows }, /* @__PURE__ */ React.createElement(Box, { flexDirection: "column" }, /* @__PURE__ */ React.createElement(Box, { marginBottom: 1 }, /* @__PURE__ */ React.createElement(Text, { bold: true }, repo)), warnings.length > 0 ? warnings.map((w, i) => /* @__PURE__ */ React.createElement(Text, { key: i, color: "yellow" }, "\u26A0 ", w)) : /* @__PURE__ */ React.createElement(Text, { dimColor: true }, "No open issues or pull requests"), /* @__PURE__ */ React.createElement(Box, { marginTop: 1 }, /* @__PURE__ */ React.createElement(Text, { color: "cyan" }, selectedIndex === 0 ? "\u276F " : "  "), /* @__PURE__ */ React.createElement(Text, { bold: selectedIndex === 0, color: "green" }, "+ Dispatch new branch"))), /* @__PURE__ */ React.createElement(Box, { justifyContent: "center" }, /* @__PURE__ */ React.createElement(Text, { dimColor: true }, "Enter dispatch \xB7 Esc back")));
  }
  const newBranchIdx = 0;
  let flatIndex = 1;
  return /* @__PURE__ */ React.createElement(Box, { flexDirection: "column", justifyContent: "space-between", borderStyle: "round", borderColor: "gray", paddingX: 1, height: terminalRows }, /* @__PURE__ */ React.createElement(Box, { flexDirection: "column" }, /* @__PURE__ */ React.createElement(Box, { marginBottom: 1 }, /* @__PURE__ */ React.createElement(Text, { bold: true }, repo), /* @__PURE__ */ React.createElement(Text, null, " \u2014 select an issue, PR, or start a new branch")), warnings.map((w, i) => /* @__PURE__ */ React.createElement(Text, { key: `warn-${i}`, color: "yellow" }, "\u26A0 ", w)), /* @__PURE__ */ React.createElement(Box, null, /* @__PURE__ */ React.createElement(Text, { color: "cyan" }, selectedIndex === newBranchIdx ? "\u276F " : "  "), /* @__PURE__ */ React.createElement(Text, { bold: selectedIndex === newBranchIdx, color: "green" }, "+ Dispatch new branch")), data.issues.length > 0 && /* @__PURE__ */ React.createElement(Box, { flexDirection: "column", marginTop: 1 }, /* @__PURE__ */ React.createElement(Text, { bold: true, color: "yellow" }, "Issues"), data.issues.map((issue) => {
    const idx = flatIndex++;
