...
function ProjectItemPicker({ project, onSelectItem, onBack, terminalRows, _fetchIssues, _fetchPrs }) {
  ...
  if (items.length === 0) {
    return /* @__PURE__ */ React.createElement(Box, { flexDirection: "column", justifyContent: "space-between", borderStyle: "round", borderColor: "gray", paddingX: 1, height: terminalRows }, /* @__PURE__ */ React.createElement(Box, { flexDirection: "column" }, /* @__PURE__ */ React.createElement(Box, { marginBottom: 1 }, /* @__PURE__ */ React.createElement(Text, { bold: true }, repo)), /* @__PURE__ */ React.createElement(Text, { dimColor: true }, "No open issues or pull requests")), /* @__PURE__ */ React.createElement(Box, { justifyContent: "center" }, /* @__PURE__ */ React.createElement(Text, { dimColor: true }, "Esc back")));
  }
  let flatIndex = 0;
  return /* @__PURE__ */ React.createElement(Box, { flexDirection: "column", justifyContent: "space-between", borderStyle: "round", borderColor: "gray", paddingX: 1, height: terminalRows }, /* @__PURE__ */ React.createElement(Box, { flexDirection: "column" }, /* @__PURE__ */ React.createElement(Box, { marginBottom: 1 }, /* @__PURE__ */ React.createElement(Text, { bold: true }, repo), /* @__PURE__ */ React.createElement(Text, null, " \u2014 select an issue or PR to dispatch")), data.issues.length > 0 && /* @__PURE__ */ React.createElement(Box, { flexDirection: "column" }, /* @__PURE__ */ React.createElement(Text, { bold: true, color: "yellow" }, "Issues"), data.issues.map((issue) => {
    const idx = flatIndex++;
  ...
  })), data.prs.length > 0 && /* @__PURE__ */ React.createElement(Box, { flexDirection: "column", marginTop: data.issues.length > 0 ? 1 : 0 }, /* @__PURE__ */ React.createElement(Text, { bold: true, color: "yellow" }, "Pull Requests"), data.prs.map((pr) => {
    const idx = flatIndex++;
