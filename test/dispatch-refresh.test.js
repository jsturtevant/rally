...
describe('refreshDispatchStatuses — session ID auto-resolution', () => {
  ...
  test('refreshDispatches continues processing when updateDispatchField throws during session resolve', () => {
    const dispatches = [
...
describe('refreshDispatchStatuses', () => {
  ...
  test('refreshDispatches leaves status unchanged when PID is dead but log is still active', () => {
    const dispatches = [
  ...
  test('refreshDispatches leaves status unchanged when PID is still running', () => {
    const dispatches = [
  ...
  test('refreshDispatches continues when updateDispatchStatus throws', () => {
    const dispatches = [
