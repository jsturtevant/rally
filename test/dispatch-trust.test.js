...
describe('checkDispatchTrust', () => {
  ...
  test('checkDispatchTrust prompts when author differs from current user', async () => {
    const exec = (cmd, args) => {
      if (args[0] === 'api' && args[1] === 'user') return 'alice\n';
  ...
  test('checkDispatchTrust prompts when user is not an org member', async () => {
    const exec = (cmd, args) => {
      if (args[0] === 'api' && args[1] === 'user') return 'alice\n';
      if (args[0] === 'issue' && args[1] === 'view') return 'alice\n';
  ...
  test('checkDispatchTrust works for PR type', async () => {
    const exec = (cmd, args) => {
      if (args[0] === 'api' && args[1] === 'user') return 'alice\n';
  ...
  test('checkDispatchTrust uses case-insensitive username comparison', async () => {
    const exec = (cmd, args) => {
      if (args[0] === 'api' && args[1] === 'user') return 'Alice\n';
      if (args[0] === 'issue' && args[1] === 'view') return 'alice\n';
      if (args[0] === 'api' && args[1].startsWith('orgs/')) return '{}';
  ...
  test('checkDispatchTrust returns false with stderr on non-TTY author mismatch without --trust', async () => {
    const exec = (cmd, args) => {
      if (args[0] === 'api' && args[1] === 'user') return 'alice\n';
      if (args[0] === 'issue' && args[1] === 'view') return 'mallory\n';
      return '';
  ...
  test('checkDispatchTrust returns false with correct message on non-TTY PR author mismatch', async () => {
    const exec = (cmd, args) => {
      if (args[0] === 'api' && args[1] === 'user') return 'alice\n';
  ...
  test('checkDispatchTrust returns true on non-TTY when author matches', async () => {
    const exec = (cmd, args) => {
      if (args[0] === 'api' && args[1] === 'user') return 'alice\n';
      if (args[0] === 'issue' && args[1] === 'view') return 'alice\n';
      return '';
  ...
  test('checkDispatchTrust returns true on non-TTY with --trust', async () => {
    const result = await checkDispatchTrust({
      type: 'issue', number: 1, repo: 'o/r',
